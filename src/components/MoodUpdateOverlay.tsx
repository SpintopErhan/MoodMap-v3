// components/MoodUpdateOverlay.tsx
"use client";

import React, { useState, useRef } from "react"; // React import'unu ekledik
...
const MoodUpdateOverlay: React.FC<MoodUpdateOverlayProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black bg-opacity-75 p-4">
      <div className="w-full max-w-md mx-auto bg-gray-900 rounded-2xl p-6 flex flex-col gap-4 relative">
