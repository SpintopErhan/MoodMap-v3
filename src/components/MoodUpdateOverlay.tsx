...
// ======== EMOJİ LİSTESİ GÜNCELLENDİ ========
const moodsEmojis = [
  // Pozitif ve Neşeli Moodlar
  "🤩", "😍", "🥰", "😊", "🙂", "🤗", "🥳", "😎", "😇", "💖", "❤️",
  // Nötr, Düşünceli veya Normal Moodlar
  "🤔", "😐", "😑", "😌", "🙃", "🧐", "🥲", "😏",
  // Yorgunluk, Üzgünlük veya Negatif Moodlar
  "😣", "😥", "😮", "😪", "😫", "🥱", "😴", "😒", "😓", "😔", "😕", 
  "☹️", "🙁", "😖", "😞", "😟", "😤", "😢", "😭", "😩", "🤯", "😬", "😰", "😱", "🥵", "🥶", "😳", 
  // Sinirli Moodlar
  "😠", "😡", "🤬", 
  // Hasta veya Rahatsız Moodlar
  "😷", "🤒", "🤕", "🤢", "🤮", "🤧",
  // Aktivite veya Ortam Moodları (Demo mood'lardan ve genel kullanım alanlarından esinlenerek)
  "☕", "📚", "💻", "🚶", "✈️", "🏖️", "🎉", "🧘", "🎵", "🎬", 
  // Hava Durumu (mood'u etkileyen)
  "☀️", "☁️", "🌧️", "⚡", "❄️", 
  // Diğer genel "vibe"ler
  "✨", "💫", "🚀", "🌈", "🌱", "💡"
];
// ==========================================
